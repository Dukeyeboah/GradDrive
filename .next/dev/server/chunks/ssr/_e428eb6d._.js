...
function AdminLoginPage() {
    ...
    const handleEmailAuth = async (e)=>{
        ...
        setLoading(true);
        // Verify passkey
        if (formData.passkey !== __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ADMIN_PASSKEY"]) {
            toast({
        ...
        try {
            ...
            if (error) {
                ...
                if (role !== 'admin') {
                    // Import setUserRole dynamically to avoid circular dependency
                    const { setUserRole } = await __turbopack_context__.A("[project]/lib/firebase/firestore.ts [app-ssr] (ecmascript, async loader)");
    ...
    const handleGoogleAuth = async ()=>{
        ...
        if (formData.passkey !== __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$admin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ADMIN_PASSKEY"]) {
            toast({
                title: 'Invalid Passkey',
                description: 'Please enter the admin passkey first.',
                variant: 'destructive'
            });
            return;
        }
        setLoading(true);
        try {
            const { user, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signInWithGoogle"])('admin');
            if (error) {
                toast({
                    title: 'Sign-in Error',
                    description: error,
...
//# sourceMappingURL=_e428eb6d._.js.map