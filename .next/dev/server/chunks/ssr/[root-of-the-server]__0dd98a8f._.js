...
async function signInWithGoogle(role = 'user', options) {
    try {
        ...
        if (options?.rejectNewUsers && isNewUser && user) {
            try {
            ...
            try {
                ...
                return {
                    user: null,
                    error: 'Could not complete sign-in. Please try again or use email and password.',
                    isNewUser: false
                };
            }
            return {
                user: null,
                error: 'Google sign-in is only for accounts that already exist. To join Grad Drive, choose Sign up, enter your access passkey, then create your account with email and password.',
                isNewUser: false
            };
        }
        return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0dd98a8f._.js.map