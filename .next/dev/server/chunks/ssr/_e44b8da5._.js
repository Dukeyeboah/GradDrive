...
function DiscountsPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (!res.ok) {
                setError(typeof payload?.error === "string" ? payload.error : "We couldn't save your interest right now. Please try again shortly.");
                setSubmitting(false);
                return;
            }
...
//# sourceMappingURL=_e44b8da5._.js.map