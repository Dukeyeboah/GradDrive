...
async function signInWithGoogle(role = 'user') {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$firebase$2b$auth$40$1$2e$8$2e$0_$40$firebase$2b$app$40$0$2e$10$2e$14$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithRedirect"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], googleProvider);
...
async function handleGoogleRedirect() {
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$firebase$2b$auth$40$1$2e$8$2e$0_$40$firebase$2b$app$40$0$2e$10$2e$14$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getRedirectResult"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"]);
        if (!result) {
            return {
                user: null,
                error: null
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            const handleRedirect = {
                "AuthProvider.useEffect.handleRedirect": async ()=>{
                    try {
                        const { user: redirectUser } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleGoogleRedirect"])();
                        if (redirectUser) {
                            // Check if photographer passkey was verified
                            const photographerVerified = ("TURBOPACK compile-time value", "object") !== 'undefined' && sessionStorage.getItem('photographerPasskeyVerified') === 'true';
                            if (photographerVerified && redirectUser.email) {
                                // Check if photographer profile exists
                                const photographer = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPhotographerByEmail"])(redirectUser.email);
                                if (photographer) {
                                    window.location.href = '/photographer-admin/dashboard';
                                    return;
                                }
                            }
                            ...
                            setTimeout({
                                "AuthProvider.useEffect.handleRedirect": async ()=>{
                                    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserData"])(redirectUser.uid);
                            ...
                            }["AuthProvider.useEffect.handleRedirect"], 500);
                        }
                    } catch (error) {
                        console.error("Error handling Google redirect:", error);
                    }
                }
            }["AuthProvider.useEffect.handleRedirect"];
            handleRedirect();
...
//# sourceMappingURL=_917b9e74._.js.map