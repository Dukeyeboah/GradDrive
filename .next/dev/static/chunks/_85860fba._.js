...
"[project]/lib/config/admin.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/admin-welcome-screen.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/config/admin.ts [app-client] (ecmascript)");
...
function AdminWelcomeScreen() {
    ...
    const handlePasskeySubmit = (e)=>{
        e.preventDefault();
        let role = null;
        if (passkey === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SUPER_ADMIN_PASSKEY"]) {
            role = "super admin";
        } else if (passkey === __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ADMIN_PASSKEY"]) {
            role = "admin";
        } else {
    ...
    const handleEmailAuth = async (e)=>{
        ...
        try {
            if (isLogin) {
                // Login flow
                const { user: authUser, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInEmailPassword"])(formData.email, formData.password);
                if (error) {
                    toast({
                        title: 'Error',
                        description: error,
                ...
                if (authUser) {
                    ...
                    const currentRole = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserRole"])(authUser.uid);
                    ...
                    if (currentRole === 'user' && (targetRole === 'admin' || targetRole === 'super admin')) {
                        try {
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setUserRole"])(authUser.uid, targetRole);
                        } catch (roleError) {
                            // Permission denied - user can't upgrade their own role
                            if (roleError.code === 'permission-denied' || roleError.message?.includes('permission') || roleError.message?.includes('insufficient permissions')) {
                                toast({
                                    title: 'Access Denied',
                    ...
                    const finalRole = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserRole"])(authUser.uid);
                ...
                // Get role from sessionStorage (set during passkey verification)
                const roleFromPasskey = ("TURBOPACK compile-time truthy", 1) ? sessionStorage.getItem("adminRole") : "TURBOPACK unreachable";
                const { user: authUser, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUpEmailPassword"])(formData.email, formData.password, formData.name, roleFromPasskey || 'admin' // Set role based on passkey
                );
                if (error) {
                    toast({
                        title: 'Error',
...
_s(AdminWelcomeScreen, "X4N8Fg2mVjv2LkzrfnMGjRv2ThY=", false, function() {
    return [
...
_c = AdminWelcomeScreen;
var _c;
__turbopack_context__.k.register(_c, "AdminWelcomeScreen");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_85860fba._.js.map