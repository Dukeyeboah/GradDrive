...
function AdminLoginPage() {
    ...
    const handleEmailAuth = async (e)=>{
        ...
        setLoading(true);
        // Verify passkey
        if (formData.passkey !== __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$admin$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ADMIN_PASSKEY"]) {
            toast({
        ...
        try {
            ...
            if (error) {
                ...
                if (role !== 'admin') {
                    ...
                    const { setUserRole } = await __turbopack_context__.A("[project]/lib/firebase/firestore.ts [app-client] (ecmascript, async loader)");
...
_s(AdminLoginPage, "cvMMDgNMyAGxRRFW5nYN1CCCZro=", false, function() {
    return [
...
//# sourceMappingURL=_4ca5f501._.js.map