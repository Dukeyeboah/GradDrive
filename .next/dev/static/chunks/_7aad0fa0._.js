...
"[project]/app/admin/posters/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminPostersPage() {
    ...
    const [posters, setPosters] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadPosters = async ()=>{
        try {
            setLoading(true);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPosters"])();
            setPosters(data);
        } catch (error) {
    ...
    const handleAddPoster = async ()=>{
        ...
        try {
            ...
            const { url, error: uploadError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadImage"])(imageFile, 'posters');
            if (uploadError || !url) {
                toast({
                    title: 'Upload Error',
            ...
            try {
                ...
                if (urlMatch) {
                    ...
                    const { url: jpgUrl, error: jpgError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFileURL"])(jpgPath);
                    if (jpgUrl && !jpgError) {
            ...
            const posterId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addPoster"])(posterData);
            if (posterId) {
                // Log the action
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addSystemLog"])('add_poster', 'poster', user.uid, userData.displayName || user.email || 'Unknown', userData.email || '', {
                    posterId,
    ...
    const handleEditPoster = async ()=>{
        ...
        try {
            ...
            if (imageFile) {
                ...
                try {
                    ...
                    if (urlMatch) {
                        ...
                        const jpgFilename = filenameWithoutPrefix.replace(/\.(png|PNG)$/, '.jpg');
                        const jpgPath = `posters/${jpgFilename}`;
                        const { url: jpgUrlResult } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getFileURL"])(jpgPath);
                        if (jpgUrlResult) {
            ...
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updatePoster"])(selectedPoster.id, updateData);
            if (success) {
                // Log the action
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addSystemLog"])('update_poster', 'poster', user.uid, userData.displayName || user.email || 'Unknown', userData.email || '', {
        ...
        try {
            ...
            if (poster.imageUrl) {
                ...
                if (urlMatch) {
                    ...
                    const { success, error } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteFile"])(storagePath);
                    if (!success && error) {
            ...
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deletePoster"])(poster.id);
            if (success) {
                // Log the action
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addSystemLog"])('delete_poster', 'poster', user.uid, userData.displayName || 'Unknown', userData.email || 'unknown@example.com', {
...
_s(AdminPostersPage, "Upw+HNRc42fuz85CYgwZIkzMKQs=", false, function() {
    return [
...
_c = AdminPostersPage;
var _c;
__turbopack_context__.k.register(_c, "AdminPostersPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_7aad0fa0._.js.map