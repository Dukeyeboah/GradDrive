...
"[project]/app/admin/cap-designs/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminCapDesignsPage() {
    ...
    const [designs, setDesigns] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$10_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const loadDesigns = async ()=>{
        try {
            setLoading(true);
            const allDesigns = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCapDesigns"])();
    ...
    const handleAddDesign = async ()=>{
        ...
        try {
            ...
            const { url, error: uploadError } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadImage"])(imageFile, "cap-designs");
            if (uploadError || !url) {
                toast({
                    title: 'Upload Error',
            ...
            const designId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addCapDesign"])(designData);
            if (designId) {
                // Log the action
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addSystemLog"])("Cap design uploaded", "cap-design", user.uid, userData.displayName || user.email || "Unknown", userData.email || "", {
                    designId,
    ...
    const handleEditDesign = async ()=>{
        ...
        try {
            ...
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCapDesign"])(selectedDesign.id, updateData);
            if (success) {
                // Log the action
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$firestore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addSystemLog"])("Cap design updated", "cap-design", user.uid, userData.displayName || user.email || "Unknown", userData.email || "", {
...
_s(AdminCapDesignsPage, "eq71e+hUDdVgSgM0jVbd46osyKQ=", false, function() {
    return [
...
_c = AdminCapDesignsPage;
var _c;
__turbopack_context__.k.register(_c, "AdminCapDesignsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_856f13c9._.js.map