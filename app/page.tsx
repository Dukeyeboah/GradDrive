...
import { GraduationCap, BookOpen, Camera, Ticket, Gift, Award } from "lucide-react"
        ...
        <section className="container py-20 md:py-32">
          <div className="mx-auto max-w-3xl text-center space-y-6">
            ...
            <h1 className="font-bold text-4xl md:text-6xl text-balance text-foreground">
              Your Graduation Journey, <span className="text-accent">Simplified</span>
            </h1>

            <p className="text-lg md:text-xl text-muted-foreground text-balance max-w-2xl mx-auto">
              Access exclusive perks, digital assets, photographer connections, and scholarship opportunities — all in
              one place.
            </p>
